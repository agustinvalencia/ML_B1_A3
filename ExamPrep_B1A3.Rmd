...
```
As seen, although that the highest training error is obtained at $i=1$, also the best validation error occurs at that treshold. This is the best scenario because we have a good generalization (given the training error) and a nice behavior in unseen data. 
